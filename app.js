...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Kliknutí a klávesnice na ročník
  document.querySelectorAll(".grade-card").forEach(card => {
  ...
  const setupSubjectEvent = (id, subject) => {
    const btn = document.getElementById(id);
    if (btn) {
      const handleSelect = () => selectSubject(subject);
  ...
  setupSubjectEvent("subject-patfyz", "patfyz");
  setupSubjectEvent("subject-patola", "patola");
  setupSubjectEvent("subject-oset", "oset");
  setupSubjectEvent("subject-farmakologie", "farmakologie");
  setupSubjectEvent("subject-dermatologie", "dermatologie");
