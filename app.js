...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const addSubjectListeners = (id, subject) => {
  ...
  addSubjectListeners("subject-patfyz", "patfyz");
  addSubjectListeners("subject-patola", "patola");
  addSubjectListeners("subject-oset", "oset");
  addSubjectListeners("subject-farmakologie", "farmakologie");
  addSubjectListeners("subject-dermatologie", "dermatologie");
