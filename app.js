...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const attachSubjectListeners = (id, subject) => {
  ...
  attachSubjectListeners("subject-patfyz", "patfyz");
  attachSubjectListeners("subject-patola", "patola");
  attachSubjectListeners("subject-oset", "oset");
  attachSubjectListeners("subject-farmakologie", "farmakologie");
  attachSubjectListeners("subject-dermatologie", "dermatologie");
