...
(function () {
  ...
  function initSupportPopup() {
    ...
    setTimeout(function() {
      ...
      const popupHtml = `
        <div id="support-popup-toast" class="support-popup-toast" role="dialog" aria-modal="false" aria-labelledby="support-popup-title">
          <div class="support-popup-header">
            <h4 class="support-popup-title" id="support-popup-title">Líbí se ti portál? ☕</h4>
